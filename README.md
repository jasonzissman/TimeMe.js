...
Notice that the code sample sets the idle duration to 30 seconds, which means 30 seconds of user
...
a complete breakdown of all of the available functionality.
